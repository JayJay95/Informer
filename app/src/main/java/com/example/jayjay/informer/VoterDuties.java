...
public class VoterDuties extends AppCompatActivity implements
        TextToSpeech.OnInitListener {

    Button speechVoterDutiesButton;
    private TextToSpeech tts;
    private TextView voterDutiesContent;
    private FirebaseAuth firebaseAuth;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_voter_duties);
        ...
        if (firebaseAuth.getCurrentUser() == null) {
                        ...
                        public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                            ...
                            if (drawerItem != null) {
                                ...
                                if (drawerItem.getIdentifier() == 1) {
                                    intent = new Intent(VoterDuties.this, HomeActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 2) {
                                    intent = new Intent(VoterDuties.this, VoterEducation.class);
                                }
                                if (drawerItem.getIdentifier() == 3) {
                                    intent = new Intent(VoterDuties.this, SearchPollingStation.class);
                                }
                                if (drawerItem.getIdentifier() == 4) {
                                    intent = new Intent(VoterDuties.this, PartiesActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 5) {
                                    intent = new Intent(VoterDuties.this, ViolationReports.class);
                                }
                                if (drawerItem.getIdentifier() == 6) {
                                    intent = new Intent(VoterDuties.this, CountDown.class);
                                }
                                if (drawerItem.getIdentifier() == 7) {
                                    intent = new Intent(VoterDuties.this, Alerts.class);
                                }
                                if (drawerItem.getIdentifier() == 8) {
                                    intent = new Intent(VoterDuties.this, VoteInvite.class);
                                }
                                if (drawerItem.getIdentifier() == 9) {
                                    intent = new Intent(VoterDuties.this, FaqList.class);
                                }
                                if (drawerItem.getIdentifier() == 10) {
                                    intent = new Intent(VoterDuties.this, PollingStations.class);
                                }
                                if (intent != null) {
                                    VoterDuties.this.startActivity(intent);
                                }
                            }
                            return false;
                        }
            ...
            voterDutiesContent = (TextView) findViewById(R.id.voterDutiesMainPageText);
            speechVoterDutiesButton = (Button) findViewById(R.id.speakVoterDutiesButton);
            speechVoterDutiesButton.setOnClickListener(new View.OnClickListener() {
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA
                ...
                speechVoterDutiesButton.setEnabled(true);
                //speakOut();
            }
    ...
    private void speakOut() {
        ...
        String text = voterDutiesContent.getText().toString();
