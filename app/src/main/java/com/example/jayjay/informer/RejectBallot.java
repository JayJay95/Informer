...
public class RejectBallot extends AppCompatActivity {
    private FirebaseAuth firebaseAuth;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reject_ballot);
                        ...
                        public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                            ...
                            if (drawerItem != null) {
                                ...
                                if (drawerItem.getIdentifier() == 1) {
                                    intent = new Intent(RejectBallot.this, HomeActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 2) {
                                    intent = new Intent(RejectBallot.this, VoterEducation.class);
                                }
                                if (drawerItem.getIdentifier() == 3) {
                                    intent = new Intent(RejectBallot.this, SearchPollingStation.class);
                                }
                                if (drawerItem.getIdentifier() == 4) {
                                    intent = new Intent(RejectBallot.this, PartiesActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 5) {
                                    intent = new Intent(RejectBallot.this, ViolationReports.class);
                                }
                                if (drawerItem.getIdentifier() == 6) {
                                    intent = new Intent(RejectBallot.this, CountDown.class);
                                }
                                if (drawerItem.getIdentifier() == 7) {
                                    intent = new Intent(RejectBallot.this, Alerts.class);
                                }
                                if (drawerItem.getIdentifier() == 8) {
                                    intent = new Intent(RejectBallot.this, VoteInvite.class);
                                }
                                if (drawerItem.getIdentifier() == 9) {
                                    intent = new Intent(RejectBallot.this, FaqList.class);
                                }
                                if (drawerItem.getIdentifier() == 10) {
                                    intent = new Intent(RejectBallot.this, PollingStations.class);
                                }
                                if (intent != null) {
                                    RejectBallot.this.startActivity(intent);
                                }
                            }
                            return false;
                        }
