 ...
 */
public class VoteInvite extends AppCompatActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener {
    private FirebaseAuth firebaseAuth;

    private static final String TAG = VoteInvite.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vote_invite);
                        ...
                        public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                            ...
                            if (drawerItem != null) {
                                ...
                                if (drawerItem.getIdentifier() == 1) {
                                    intent = new Intent(VoteInvite.this, HomeActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 2) {
                                    intent = new Intent(VoteInvite.this, VoterEducation.class);
                                }
                                if (drawerItem.getIdentifier() == 3) {
                                    intent = new Intent(VoteInvite.this, SearchPollingStation.class);
                                }
                                if (drawerItem.getIdentifier() == 4) {
                                    intent = new Intent(VoteInvite.this, PartiesActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 5) {
                                    intent = new Intent(VoteInvite.this, ViolationReports.class);
                                }
                                if (drawerItem.getIdentifier() == 6) {
                                    intent = new Intent(VoteInvite.this, CountDown.class);
                                }
                                if (drawerItem.getIdentifier() == 7) {
                                    intent = new Intent(VoteInvite.this, Alerts.class);
                                }
                                if (drawerItem.getIdentifier() == 8) {
                                    intent = new Intent(VoteInvite.this, VoteInvite.class);
                                }
                                if (drawerItem.getIdentifier() == 9) {
                                    intent = new Intent(VoteInvite.this, FaqList.class);
                                }
                                if (drawerItem.getIdentifier() == 10) {
                                    intent = new Intent(VoteInvite.this, PollingStations.class);
                                }
                                if (intent != null) {
                                    VoteInvite.this.startActivity(intent);
                                }
                            }
                            return false;
                        }
        ...
        findViewById(R.id.vote_invite_button).setOnClickListener(this);
        // [END_EXCLUDE]
