                        ...
                        public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                            ...
                            if (drawerItem != null) {
                                ...
                                if (drawerItem.getIdentifier() == 1) {
                                    intent = new Intent(VotingMainPage.this, HomeActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 2) {
                                    intent = new Intent(VotingMainPage.this, VoterEducation.class);
                                }
                                if (drawerItem.getIdentifier() == 3) {
                                    intent = new Intent(VotingMainPage.this, SearchPollingStation.class);
                                }
                                if (drawerItem.getIdentifier() == 4) {
                                    intent = new Intent(VotingMainPage.this, PartiesActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 5) {
                                    intent = new Intent(VotingMainPage.this, ViolationReports.class);
                                }
                                if (drawerItem.getIdentifier() == 6) {
                                    intent = new Intent(VotingMainPage.this, CountDown.class);
                                }
                                if (drawerItem.getIdentifier() == 7) {
                                    intent = new Intent(VotingMainPage.this, Alerts.class);
                                }
                                if (drawerItem.getIdentifier() == 8) {
                                    intent = new Intent(VotingMainPage.this, VoteInvite.class);
                                }
