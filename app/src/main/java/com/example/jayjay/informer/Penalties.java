...
public class Penalties extends AppCompatActivity implements
        TextToSpeech.OnInitListener {

    Button speechElectionPenaltiesButton;
    private TextToSpeech tts;
    private TextView electionPenaltiesContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() == null) {
                        ...
                        public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                            ...
                            if (drawerItem != null) {
                                ...
                                if (drawerItem.getIdentifier() == 1) {
                                    intent = new Intent(Penalties.this, HomeActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 2) {
                                    intent = new Intent(Penalties.this, VoterEducation.class);
                                }
                                if (drawerItem.getIdentifier() == 3) {
                                    intent = new Intent(Penalties.this, SearchPollingStation.class);
                                }
                                if (drawerItem.getIdentifier() == 4) {
                                    intent = new Intent(Penalties.this, PartiesActivity.class);
                                }
                                if (drawerItem.getIdentifier() == 5) {
                                    intent = new Intent(Penalties.this, ViolationReports.class);
                                }
                                if (drawerItem.getIdentifier() == 6) {
                                    intent = new Intent(Penalties.this, CountDown.class);
                                }
                                if (drawerItem.getIdentifier() == 7) {
                                    intent = new Intent(Penalties.this, Alerts.class);
                                }
                                if (drawerItem.getIdentifier() == 8) {
                                    intent = new Intent(Penalties.this, VoteInvite.class);
                                }
                                if (drawerItem.getIdentifier() == 9) {
                                    intent = new Intent(Penalties.this, FaqList.class);
                                }
                                if (drawerItem.getIdentifier() == 10) {
                                    intent = new Intent(Penalties.this, PollingStations.class);
                                }
                                if (intent != null) {
                                    Penalties.this.startActivity(intent);
                                }
                            }
                            return false;
                        }
            ...
            electionPenaltiesContent = (TextView) findViewById(R.id.electionPenaltiesMainPageText);
            speechElectionPenaltiesButton = (Button) findViewById(R.id.speakElectionPenaltiesButton);
            speechElectionPenaltiesButton.setOnClickListener(new View.OnClickListener() {
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA
                ...
                speechElectionPenaltiesButton.setEnabled(true);
                //speakOut();
            }
    ...
    private void speakOut() {
        ...
        String text = electionPenaltiesContent.getText().toString();
